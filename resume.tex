...
\begin{rSection}{\textbf{Projects}}
  ...
  \begin{rSubsection}{Axys}
    ...
    \item Constructed a web platform to help developers connect with designers and collaborate on projects
  ...
  \begin{rSubsection}{bigRSA}
   ...
   \begin{rSubsection}{Biquadris}
    ...
    \item Developed a turn-based Tetris game, complete with varying levels, greedy hinting, and a ncurses display
