...
\begin{rSection}{\textbf{Work Experience}}
  \begin{rSubsection}{The Co-Operators}
    {Jan -- Apr '19}
         ...
         {Waterloo, ON}
       \item Built a cross-platform chatbot using node.js that collects data for a quote generation program by parsing documents and sorting questions by relevance, decreasing quote generation time for advisers by 81\%
