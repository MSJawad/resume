...
\begin{rSection}{Skills}
  ...
  \begin{list}{$\cdot$}{\leftmargin=0.5em}
    ...
    \item Skilled in Javascript, C++, C, Python, Scheme, R, SQL, Golang, Django, Bash, Git, Keras and Tensorflow
...
\begin{rSection}{Work Experience}
  \begin{rSubsection}{The Co-Operators}
    ...
    \item Authored search by relevance functionality in the hiring program, allowing it to deliver articles, text and smart image searches and look up questions and forms in the program's question tree
...
\begin{rSection}{Projects}
  ...
  \begin{rSubsection}{Axys}
    ...
    \item Developed a web platform to help developers connect with designers to collaborate on projects
